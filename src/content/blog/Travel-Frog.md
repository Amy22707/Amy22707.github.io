...
到现在，整个游戏的功能基本上全部实现并校准了。接下来的工作是等周六抓包正式服的聚会返程、旅游返程及“周末的小插曲”的回礼，并对项目作整体审查。完成以上内容后，将游戏的限时活动恢复春节、中秋与周年庆的限时周期，并开始开发破解版本（活动全部常驻、资源无限并全部解锁）。完成开发后，开始打包并尝试寻找可迁移的方法。