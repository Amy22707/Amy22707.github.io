...
命运的雨水悉数落在旅者颠沛流离的路途上，教训并不惨痛，只是单纯的遗憾，是始终暗藏于角落的潮湿。
...
于是更新了[github主页](https://amy22707.github.io/)，重新打开了许久未更新的博客，以翻开新的一页。

之所以叫复健，一是因为oi学的内容基本上忘光了，二是因为语言变成了python。所以只能再从最基础的地方出发，撕开一角世界浩瀚的面纱。
